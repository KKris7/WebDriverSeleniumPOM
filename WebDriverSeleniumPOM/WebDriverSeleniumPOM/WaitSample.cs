...
namespace WaitSample
{
    public class WaitFull
    {
        ...
        [Test]
        public void _01Test_Wait_Thread_Sleep()
        {
        ...
        [Test]
        public void _02Test_Wait_ImplicitWait()
        {
            this.driver = new ChromeDriver();
        ...
        [Test]
        public void _03Test_Wait_ExplicitWait()
        {
            this.driver = new ChromeDriver();
            ...
            var element = this.wait.Until(driver =>
            {
            ...
            var element1 = this.wait.Until(driver =>
            {
                return driver.FindElement(By.ClassName("ContactUs")).Text;
            });
        ...
        [Test]
        public void _04Test_Wait_UsingExtras()
        {
            this.driver = new ChromeDriver();
            this.wait = new WebDriverWait(driver, TimeSpan.FromSeconds(15));
            driver.Manage().Window.Maximize();
            ...
            var element = this.wait.Until(
                ExpectedConditions.ElementIsVisible(By.ClassName("ContactUs"))).Text;
